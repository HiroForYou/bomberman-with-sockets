...
public class Game extends JPanel {
   ...
   Game(int width, int height) {
      ...
      try {
         System.out.print("Inicializando jugadores...");
      ...
      System.out.println("Mi jugador: " + Sprite.personColors[Client.id]);
   }

   // dibujar los componentes, llamados por paint() y repaint()
   public void paintComponent(Graphics g) {
      ...
      // System.out.format("%s: %s [%04d, %04d]\n", Game.you.color, Game.you.status,
